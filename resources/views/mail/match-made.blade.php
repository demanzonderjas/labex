...
@section('title', 'LABEXUS - A new match has been made!')
...
@section('content')
    <p>
        ...
        View the status of the match within the platform. When approved, you can exchange your materials with the connected
        person.
    </p>
@stop
